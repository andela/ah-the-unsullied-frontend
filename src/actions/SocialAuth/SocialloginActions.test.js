...
it('should return twitter auth data', () => {
  ...
  expect(testActions.TwitterAuthentication(twitterPayload)).toEqual(
    twitterPayload
  );
});
...
it('should return facebook auth data', () => {
  ...
  expect(testActions.FacebookAuthentication(facebookPayload)).toEqual(
    facebookPayload
  );
});
...
it('should return google auth data', () => {
  ...
  expect(testActions.FacebookAuthentication(googlePayload)).toEqual(
    googlePayload
  );
});
